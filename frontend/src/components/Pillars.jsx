      ...
      <div className="mx-auto max-w-[1320px] px-6 sm:px-10">
        <div className="grid grid-cols-12 gap-6 mb-16 items-end">
          <div className="col-span-12 md:col-span-7">
            <div className="label-eyebrow mb-5">ما أبني</div>
            <h2 className="font-display text-4xl sm:text-5xl lg:text-[64px] leading-[1.02] tracking-tight">
              أدوات تعليميّة وذكاء اصطناعي
              <br />
              <span className="font-serif-italic text-[color:var(--ink-4)]">تُبسّط ما هو معقّد.</span>
            </h2>
          </div>
          <div className="col-span-12 md:col-span-5 md:text-left">
            <p className="text-[15px] leading-[1.9] text-[color:var(--ink-4)] max-w-md md:ml-auto">
              أربعة محاور، ومهمّة واحدة: بناء برمجيات ذكيّة تُحدث فرقًا حقيقيًا في حياة الطالب والمطوّر.
            </p>
          </div>
        </div>
